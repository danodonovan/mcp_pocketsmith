...
def register_all_tools(
    ...
    """
    register_user_tools(mcp, client, user_ctx, read_only=read_only)
    register_account_tools(mcp, client, user_ctx, read_only=read_only)
    register_transaction_account_tools(mcp, client, user_ctx, read_only=read_only)
    register_transaction_tools(mcp, client, user_ctx, read_only=read_only)
    register_category_tools(mcp, client, user_ctx, read_only=read_only)
    register_budgeting_tools(mcp, client, user_ctx, read_only=read_only)
    register_institution_tools(mcp, client, user_ctx, read_only=read_only)
    register_event_tools(mcp, client, user_ctx, read_only=read_only)
    register_attachment_tools(mcp, client, user_ctx, read_only=read_only)
    register_label_tools(mcp, client, user_ctx)
    register_utility_tools(mcp, client)
    register_bulk_transaction_tools(mcp, client, read_only=read_only)
